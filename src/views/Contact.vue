<template lang="">
  <div class="md:container text-center pt-10 m-20">
    <h2 class="text-4xl font-bold text-center no-underline text-amber-400">
      Contact
    </h2>
    <div
      class="grid grid-flow-row auto-rows-max hover:row-span-3 grid-cols-6 gap-3 p-6 m-5 text-white"
    >
      <div
